...
func init() {
	mb.Registry.MustAddMetricSet(opendistro.ModuleName, "node", New,
...
func New(base mb.BaseMetricSet) (mb.MetricSet, error) {
	ms, err := opendistro.NewMetricSet(base, nodeStatsPath)
	if err != nil {
		return nil, err
	}
...
func (m *MetricSet) Fetch(r mb.ReporterV2) error {
	...
	info, err := opendistro.GetInfo(m.HTTP, m.HostData().SanitizedURI+nodeStatsPath)
	if err != nil {
